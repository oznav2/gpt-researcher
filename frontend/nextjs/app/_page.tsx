      ...
      <main className="flex-grow flex flex-col lg:flex-row overflow-hidden">
        ...
        <div
          className={`flex flex-col transition-all duration-500 ${
            showResult ? 'w-full lg:w-1/2' : 'w-full'
          }`}
        >
          {/* Always render InputArea, adjust visibility with CSS */}
          <div className={`transition-all duration-500 ease-in-out ${
            showResult ? 'translate-y-0 opacity-100' : 'translate-y-0 opacity-100 lg:translate-y-1/2 lg:opacity-0'
          }`}>
            <InputArea
          ...
          {/* Render Hero only when not showing results and not transitioning */}
        ...
        <div
          className={`flex flex-col transition-all duration-500 ${
            showResult ? 'w-full lg:w-1/2 opacity-100' : 'w-0 opacity-0 overflow-hidden'
          }`}
        >
          {/* Scrollable container for right report components */}
          <div className="flex-grow overflow-y-auto bg-gray-900 rounded-lg shadow-inner p-4 sm:p-6 lg:p-8">
            {showResult && (
