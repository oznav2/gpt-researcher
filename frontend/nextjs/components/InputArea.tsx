...
const InputArea: FC<TInputAreaProps> = ({
  ...
  return (
    ...
    >
      <input
        type="text"
        placeholder="מהו נושא המחקר שתרצה לחקור?"
      ...
      <button
        disabled={disabled}
        type="submit"
        className="relative flex h-[50px] w-[50px] shrink-0 items-center justify-center rounded-[3px] bg-blue-500 disabled:pointer-events-none disabled:opacity-75"
      >
        {disabled && (
