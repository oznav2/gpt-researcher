...
def calculate_cost(
    ...
    costs = {
        ...
        "ollama-llama3.1": 0.0001,
        "ollama-dictalm2.0-instruct.Q8_0.gguf:latest": 0.0001,
        "ollama-dictalm2.0-instruct.Q5_K_M.gguf:latest": 0.0001,
        "ollama-dictalm2.0-instruct.Q4_K_M.gguf:latest": 0.0001,
        "ollama-dictalm2.0-instruct.Q4_0.gguf:latest": 0.0001,
        "wizardlm2:latest": 0.0001,
    ...
    if model not in costs:
        logger.warning(
            f"מודל לא מוכר: {model}. ייתכן שהחישוב של העלות יהיה שגוי.")
        return 0.0
