...
examples:
task: "האם כדאי לי להשקיע במניות של אפל?"
response: 
{
    "server": "💰 סוכן השקעות ופיננסים",
...
task: "האם למכור נעלי ספורט בחנות אינטרנט היא עסק כדאי ומשתלם היום?"
response: 
{ 
    "server":  "📈 סוכן ניהול עסקים ואנליסט",
...
task: "מהם המקומות הכי מענינים לבקר בהם כתייר בתל אביב?"
response:
{
    "server:  "🌍 סוכן טיול ומסלולים",
...
- You MUST include markdown hyperlinks to relevant source URLs wherever referenced in the report, for example:
    ...
    זהו טקסט דוגמה. ([url website](url))
...
- The focus MUST be on the main topic! You MUST Leave out any information un-related to it!
- Must NOT have any introduction, conclusion, summary or reference section.
- Focus solely on creating relevant headers in Hebrew Language, not content.
"""
...
- The introduction should be in Hebrew Language, succinct, well-structured, informative with markdown syntax.
