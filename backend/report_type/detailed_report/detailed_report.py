...
class DetailedReport:
    ...
    async def _initial_research(self) -> None:
        ...
        self.global_urls.update(self.main_task_assistant.visited_urls)
    ...
    async def _construct_detailed_report(self, introduction: str, report_body: str) -> str:
        ...
        try:
            conclusion = await self.main_task_assistant.report_generator.write_report_conclusion(report_body)
        except Exception as e:
            print(f"Error in writing conclusion: {e}")
